  ...
  return (
    <div className='flex justify-around main custom-background'>
        <div className='w-2/4 ml-5'>
            ...
            <ToastContainer/>
            <button className='border border-primary p-3  my-8 bg-primary text-white hover:-translate-y-2 rounded text-1xl transition-all'><Link to="/dashboard">Read More</Link></button>
        </div>
